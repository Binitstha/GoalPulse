    ...
    <>
      <section className="border-r-2 h-full p-3 flex flex-col gap-3">
        <div className="bg-blue-400 h-40 rounded-lg flex justify-items-end items-center p-3 text-3xl">
          <div className="mt-auto flex border-2 w-full justify-start items-center gap-1">
            <Link href={'/dashboard'}>
              <div className="flex items-end justify-end relative ">
                <Image src='/logo.png' alt="logo" width={70} className="absolute left-0 top-[-60px]" height={30}/>
                <p className="text-end ">GoalPulse</p>
              </div>
            </Link>
          </div>
        </div>
